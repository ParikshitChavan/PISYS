...
@Component({
  selector: 'app-init-candi-acc',
  templateUrl: './init-candi-acc.component.html',
  styleUrls: ['./init-candi-acc.component.scss']
})
export class InitCandiAccComponent implements OnInit {
